        ...
        <ul class="pagination">
            ...
            <c:choose>
                <c:when test="${pageBean.currentBlock>1 }">
                    <li>
                        <a href="${pageContext.request.contextPath}/listSelect.do?cmd=listSelect&page=${pageBean.startPage-1}">이전</a>
                    </li>
                </c:when>
            ...
            <c:forEach var="i" begin="${pageBean.startPage}" end="${pageBean.endPage}">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${pageContext.request.contextPath}/listSelect.do?cmd=listSelect&page=${i}">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            ...
            <c:choose>
                <c:when test="${pageBean.totalPage > pageBean.endPage }">
                    <li>
                        <a href="${pageContext.request.contextPath}/listSelect.do?cmd=listSelect&page=${pageBean.endPage+1}">다음</a>
                    </li>
                </c:when>
                <c:otherwise>
                    <li><a href="#">다음</a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/listSelect.do?cmd=listSelect&page=${pageBean.totalPage}">마지막으로</a>
            </li>

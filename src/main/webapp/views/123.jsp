    ...
    <div class="col-md-8">
        ...
        <div class="list-group">
            <c:forEach var="i" items="${boardList}">
                <a href="info.do?cmd=info&no=${i.no}" class="list-group-item">
                    <div class="board-title">
                        <span class="board-category">${i.category}</span>
        ...
        <div class="col-md-8">
            <ul class="pagination">
                <c:if test="${pageBean.currentBlock > 1}">
                    <li><a
                            href="${pageContext.request.contextPath}/listSelect.do?cmd=listSelect&page=${pageBean.startPage-1}">이전</a></li>
                </c:if>

                <c:forEach var="i" begin="${pageBean.startPage}" end="${pageBean.endPage}">
                    <c:choose>
                        <c:when test="${i eq pageBean.currentPage}">
                            <li><a href="#"><font color="red" size="4">[${i}]</font></a></li>
                        </c:when>
                        <c:otherwise>
                            <li><a
                                    href="${pageContext.request.contextPath}/listSelect.do?cmd=listSelect&&page=${i}">
                                [${i}]</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
